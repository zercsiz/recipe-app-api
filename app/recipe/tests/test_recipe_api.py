...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            ...
            # because when using save, the pointer is at the end of the file
            # to be able to upload the file, we should place the pointer at the
            # beginning of the file. (seek(0))
            image_file.seek(0)
